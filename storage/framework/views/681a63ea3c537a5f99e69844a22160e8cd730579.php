                ...
                <div class="map-item-group"
                    ...
                    <div class="map-item-close"
                        ...
                        <div class="map-item-close-line-2 maximum"
                            style="background:#000; width:15px; height:2px;position: absolute;
                        transform: rotate(-45deg);" data-maximum="<?php echo e($maximum_radius); ?>">
                        </div>
                    </div>
...
<?php $__env->startSection('scripts'); ?>
    <script
        ...
        defer></script>
    <script src="/js/pages/map.js?v=<?php echo e(time()); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.main-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/manam/public_html/resources/views/pages/map-system/map.blade.php ENDPATH**/ ?>