                ...
                <div class="slip-item">
                    <div class="slip-item-header">
                        <figure class="slip-item-header-icon">
                            <img src="/img/evidence/headericon.png" alt="evidenceIcon" />
                        </figure>
                    ...
                    <div class="slip-item-content">
                        <figure class="slip-item-content-image">
                            <img src="/img/evidence/evidenceimg1.png" alt="evidenceImage1">
                        </figure>
                        <figure class="slip-item-content-image">
                            <img src="/img/evidence/evidenceimg2.png" alt="evidenceImage2">
                        </figure>
                    </div>
                </div>
            </div>
