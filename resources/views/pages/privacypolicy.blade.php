...
<body>
        ...
        <div class="pp">
            <div class="pp-item">
                <div class="pp-item-header">
                    <figure class="pp-item-header-icon">
                        <img src="/img/privacy policy/headericon.png" alt="TermOfServiceIcon" />
                    </figure>
                    <div class="pp-item-header-title">
                        <p>Privacy Policy</p>
                    </div>
                </div>
                <div class="pp-item-content">
                    <div class="pp-item-content-title">
                        <p>Privacy Policy</p>
                    </div>
                    <div class="pp-item-content-description">
                        <p>
    ...
    <script src="/js/pages/privacypolicy.js"></script>
