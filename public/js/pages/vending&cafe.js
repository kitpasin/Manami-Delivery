...
function dropDown() {
  let dd = document.querySelector(".vac-item-branch-list-description-dropdown");
  let pickup = document.querySelector(".vac-item-pickup");
...
const figures = document.querySelectorAll(".vac-item-pickup-button button figure") 
...
const foodTypes = document.querySelectorAll(".vac-item-type-content-group");
foodTypes.forEach((foodType) => {
  foodType.addEventListener("click", function () {
    if (foodType.classList.contains("active")) {
      this.classList.remove("active");
    } else {
      foodTypes.forEach((el) => el.classList.remove("active"));
      this.classList.add("active");
    }
  });
});

const washTypes = document.querySelectorAll(".vac-item-type-washing-content-group");
