...
// const target = document.querySelector(".wad-item-detaillist-title p");
// const text = "START"
// let index = 0

// const printText = setInterval(function() {
...
function dropDown() {
    ...
    let pickup = document.querySelector(".wad-item-pickup");
...
function timeNow() {
    ...
    document.getElementById("datetime3").style.display = "none";
}
...
function dropOff() {
    document.getElementById("datetime1").style.display = "none";
    document.getElementById("datetime2").style.display = "none";
    document.getElementById("datetime3").style.display = "block";
}
...
const clothTypes = document.querySelectorAll(
    ".wad-item-type-clothing-content-group"
);
clothTypes.forEach((clothType) => {
    clothType.addEventListener("click", function () {
...
function wadPage() {
    const washing = document.querySelectorAll(
        ".wad-item-type-washing-content-group"
    )[0];
    const drying = document.querySelectorAll(
        ".wad-item-type-washing-content-group"
    )[1];
    if (washing.classList.contains("active")) {
        window.location.href = "/wash&dry/washing";
    } else if (drying.classList.contains("active")) {
        ...
        Swal.fire({
            ...
            text: "Please select Washing or Drying first.",
...
//                 scope.currentViewDate.setMonth(
//                     scope.currentViewDate.getMonth() + 1
//                 );
...
//                     scope.currentoffset = parseInt(
//                         hours_offset + minutes_offset - 1
//                     );
//                     currenttime.css({
...
//                     // get hours
//                     var percenttime =
//                         (scope.currentoffset + 1) / timeline_width;
